...
export default function Capabilities() {
    return (
        <div className="items-center absolute border border-white">
            <div className="">
                <h1 className="text-white font-bold text-xl">Tools And Technologies</h1>
            </div>
            <div className="flex justify-center px-20 space-x-8">
